...
for db in identity rbac tool_plane case_svc realtimehub dataset ingestion ai_gateway agent_runtime memory pipeline experiment inference usage fhir_bridge; do
