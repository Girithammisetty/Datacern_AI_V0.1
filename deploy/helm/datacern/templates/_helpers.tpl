{{/*
Common helpers for the Datacern umbrella chart.
*/}}

{{- define "datacern.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Common labels applied to every object. */}}
{{- define "datacern.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
app.kubernetes.io/part-of: datacern
...
*/}}
{{- define "datacern.migrateCommand" -}}
...
{{- define "datacern.readyPath" -}}
{{- default "/readyz" .svc.health -}}
{{- end -}}

{{/* The liveness probe path for a service (default /healthz). */}}
{{- define "datacern.livePath" -}}
{{- default "/healthz" .svc.liveness -}}
{{- end -}}

{{/* ServiceAccount name used by every workload. */}}
{{- define "datacern.serviceAccountName" -}}
{{- default (printf "%s-sa" (include "datacern.name" .)) .Values.serviceAccount.name -}}
{{- end -}}
