...
Agentic commerce: Google Cloud AP2 announcement (Sept 2025); Visa Trusted Agent Protocol (Oct 2025); Eco on Mastercard Agent Pay; Rivero/Chargebacks911/Chargeflow/Justt on the dispute gap; Forbes on Gartner's $30T machine-customer projection (Feb 2025).
