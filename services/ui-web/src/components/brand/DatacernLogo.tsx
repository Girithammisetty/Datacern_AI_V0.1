/**
 * Datacern AI logo — a compass-dial decision graph: eight bearings radiate
 * from a center point, each ending in a data node (candidate decisions); one
 * bearing (NE) is resolved into a bold arrow with a filled node — the chosen
 * decision. The dashed ring is the compass dial / governance boundary every
 * decision passes through. Decision Intelligence, literally: many weighed
 * directions, one confident, auditable bearing.
 *
