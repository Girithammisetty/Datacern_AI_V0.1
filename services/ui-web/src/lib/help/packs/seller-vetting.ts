...
export const sellerVettingGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A case-triage vetting assistant and a marketplace-integrity analytics agent (tenant-specialized, proposal-mode)",
