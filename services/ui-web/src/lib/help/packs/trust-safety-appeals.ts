...
export const trustSafetyAppealsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "An appeals-triage assistant and an appeals-operations analytics agent, specialized to the trust-and-safety domain",
