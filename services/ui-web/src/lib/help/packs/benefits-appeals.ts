...
export const benefitsAppealsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A benefits-adjudication triage assistant and a program-operations analytics agent (tenant-specialized)",
