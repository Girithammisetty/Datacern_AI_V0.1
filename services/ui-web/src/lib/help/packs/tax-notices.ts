...
export const taxNoticesGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A notice-intake triage assistant and a tax-notice-operations analytics agent",
