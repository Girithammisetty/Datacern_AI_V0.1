...
export const healthcareProviderRcmGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A denials-specialist triage assistant (CARC/RARC classification, deadline-aware) and a revenue-cycle analytics agent",
