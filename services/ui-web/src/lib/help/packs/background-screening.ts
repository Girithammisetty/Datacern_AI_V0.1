...
export const backgroundScreeningGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A hit-adjudication triage assistant and a screening-operations analytics agent (proposal-mode, four-eyes)",
