...
export const underwritingIntakeGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A submission-intake triage assistant and an underwriting-operations analytics agent",
