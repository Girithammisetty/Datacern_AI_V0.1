...
export const tradeComplianceGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A trade-review triage assistant and a trade-analytics agent (specialized platform agents, proposal-mode)",
