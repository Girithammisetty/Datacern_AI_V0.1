...
export const bankingAmlGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "An AML alert-triage assistant and a financial-crime analytics agent",
