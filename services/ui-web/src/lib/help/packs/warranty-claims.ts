...
export const warrantyClaimsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A claim-triage assistant and a warranty-operations analytics agent (tenant-specialized)",
