...
export const pharmacovigilanceGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      ...
      "items": [
        "An ICSR-triage assistant and a PV analytics agent (domain-specialized, always proposal-mode)",
