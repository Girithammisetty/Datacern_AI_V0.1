...
export const truckingClaimsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A trucking-specialized claims/safety triage assistant and a claims-and-safety analytics agent",
