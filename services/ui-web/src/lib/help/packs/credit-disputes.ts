...
export const creditDisputesGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A reinvestigation triage assistant and a dispute-operations analytics agent, specialized to the FCRA/Reg V domain",
