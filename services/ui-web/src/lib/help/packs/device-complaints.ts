...
export const deviceComplaintsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A complaint-intake triage assistant and a device-quality analytics agent (both proposal-mode)",
