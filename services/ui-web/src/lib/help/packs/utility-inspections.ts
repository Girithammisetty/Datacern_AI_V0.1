...
export const utilityInspectionsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A finding-triage assistant and an inspection-program analytics agent (proposal-mode, four-eyes)",
