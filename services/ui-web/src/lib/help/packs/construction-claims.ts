...
export const constructionClaimsGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A claim-intake triage assistant and a claims-operations analytics agent (proposal-mode, four-eyes)",
