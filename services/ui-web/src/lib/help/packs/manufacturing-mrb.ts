...
export const manufacturingMrbGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A domain-tuned NC intake / MRB triage assistant and a quality-operations analytics agent (proposal-mode, four-eyes)",
