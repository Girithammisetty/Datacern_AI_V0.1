...
export const pharmacyBenefitMgmtGuide: PackGuide = {
  ...
  "summary": "AI-assisted **pharmacy benefit management** for PBMs, health plans, and Medicare Part D sponsors. It runs the Rx **prior-authorization** review desk — grounded in formulary tier, step-therapy, and quantity-limit criteria — alongside **DUR** (drug utilization review) safety-alert triage, with a pharmacist recording every determination and a second reviewer approving any write-back (four-eyes).\n\nOn top of the case desk it ships PBM KPI **semantic models** (generic dispensing rate, PA turnaround against the CMS Part D coverage-determination windows, rebate capture, PMPM), three **dashboards**, a domain-grounded **assistant**, and a PA auto-decision training pipeline. By design the assistant only ever *recommends* — an adverse coverage determination is always a licensed human pharmacist's decision, and controlled-substance PAs never auto-approve.",
  "ships": [
    {
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A PA/DUR triage assistant (clinical-pharmacist persona) and a PBM analytics agent, specialized via tenant config",
