...
export const apInvoiceAuditGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "An exception-triage assistant and an AP-controls analytics agent (proposal-mode, four-eyes)",
