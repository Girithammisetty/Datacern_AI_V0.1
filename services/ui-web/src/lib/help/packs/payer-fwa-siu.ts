...
export const payerFwaSiuGuide: PackGuide = {
  ...
  "ships": [
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "An SIU-tuned case-triage assistant that grounds recommendations in peer-group deviation, E/M distribution, NCCI pairs, and exclusion status — never accusing, always citing",
