...
export const postAcuteCareGuide: PackGuide = {
  ...
  "summary": "\nAI-assisted review for **post-acute care** operators — home health, skilled nursing (SNF), and hospice. It brings the clinical and intake desks together around **PDGM/PDPM episode and assessment** analytics, referral intake, and 30-day rehospitalization risk, with a domain-grounded assistant that drafts recommendations and a second person who approves every write-back.\n\nReviewers work OASIS/MDS assessment flags, PDGM comorbidity and PDPM therapy-alignment optimizations, referral-triage decisions, and readmission-risk interventions — grounded in source documentation so every proposed code is **CERT/RAC/UPIC defensible**. The assistant **never** finalizes an assessment or makes an eligibility call; clinical staff and a manager always do (BR-1).\n",
  "ships": [
    {
    ...
    },
    {
      "label": "AI & grounding",
      "items": [
        "A post-acute care-transition triage assistant and a post-acute network analytics agent (specialized platform agents, proposal-mode + four-eyes)",
