# Datacern authorization policy — INPUT-projection variant (MASTER-FR-012).
#
# The canonical policy (datacern_authz.rego, package datacern.authz) evaluates
...
# match, NOT "*"). Mirrors decide.go + datacern_authz.rego. A service principal
