"""Event bus implementations (in-memory double for unit/dev; real Kafka for runtime)."""
...
class InMemoryEventBus:
    """In-memory fake of the Kafka bus: records envelopes and dispatches to subs."""
...
class KafkaEventBus:
    """Real Kafka (Redpanda) event bus via the shared ``datacern_common`` idempotent
    producer; publishes the master envelope keyed by tenant_id. Runtime event bus."""
