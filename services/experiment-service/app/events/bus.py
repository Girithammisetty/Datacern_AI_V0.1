"""Event bus + consumer dedup implementations (unit doubles + real adapters)."""
...
class InMemoryEventBus:
    """Unit/dev double: records published envelopes and dispatches to subscribers."""
...
class InMemoryDedupStore:
    """Dedup double (Redis in prod). Check and mark are separate (handle-then-mark)."""
...
class RedisDedupStore:
    """Real Redis consumer dedup (24h TTL) via the shared datacern_common store."""
