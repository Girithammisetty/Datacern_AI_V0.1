...
All four speak the same path scheme Datacern already uses for Vault refs
...
def _sanitize_name(prefix: str, path: str) -> str:
    ...
    Secret Manager). Deterministic and collision-safe enough for Datacern's own
